...
//        [self setGestureToAllScrollView];
...
-(void)addGestureOfView:(id)view
{
    if ([view isKindOfClass:[UITableView class]] || [view isKindOfClass:[UICollectionView class]]) {
        ...
        [self.gestureArray addObject:recognizer];
...
{
    int i = 0;
    for (id view in self.viewsArray) {
        
        [view removeGestureRecognizer:self.gestureArray[i]];
        i++;
    }
}
-(void)dealloc
